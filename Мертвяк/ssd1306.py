...
class SSD1306:
    ...
    def init_display(self):
        for cmd in (
            ...
            SET_CONTRAST, 0x9F if self.external_vcc else 0xCF,
    ...
    def contrast(self, contrast): self.write_cmd(SET_CONTRAST, contrast)
...
class SSD1306_I2C(SSD1306):
    ...
    def write_cmd(self, cmd):
        self.temp[0] = 0x00 # Сигнал: идет команда
        self.temp[1] = cmd
        self.i2c.writeto(self.addr, self.temp)

    def write_data(self, buf):
        # Отправляем префикс 0x40 (данные RAM) перед основным буфером кадра
